...
const App = () => {
    const bloco1 = () => ({margin: 'auto', width: 800, backgroundColor: '#dcdcdc', padding: 12, borderRadius: 8 })
  ...
  return(
    ...
    <div style={{margin: 'auto', width: 700, backgroundColor: '#e4e4e4', padding: 12, borderRadius: 8 }}> 
        ...
        <div className='bloco2'>    
            ...
            <div className='dois'>
            <img src={process.env.PUBLIC_URL + "/imagem2.jpg"}/>
                {nome2.nome}</div>
            <div className='tres'>
